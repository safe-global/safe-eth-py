...
from ..constants import CALL_DATA_BYTE
...
class TestEthereumClient(EthereumTestCaseMixin, TestCase):
    ...
    def test_estimate_data_gas(self):
        ...
        self.assertEqual(self.ethereum_client.estimate_data_gas(HexBytes('0x000204')), 4 + CALL_DATA_BYTE * 2)
        self.assertEqual(self.ethereum_client.estimate_data_gas(HexBytes('0x050204')), CALL_DATA_BYTE * 3)
        self.assertEqual(self.ethereum_client.estimate_data_gas(HexBytes('0x0502040000')), CALL_DATA_BYTE * 3 + 4 * 2)
        self.assertEqual(self.ethereum_client.estimate_data_gas(HexBytes('0x050204000001')), CALL_DATA_BYTE * 4 + 4 * 2)
        self.assertEqual(self.ethereum_client.estimate_data_gas(HexBytes('0x00050204000001')),
                         4 + CALL_DATA_BYTE * 4 + 4 * 2)
