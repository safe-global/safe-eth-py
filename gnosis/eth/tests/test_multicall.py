...
class TestMulticallGanache(EthereumTestCaseMixin, TestCase):
    ...
    @mock.patch.object(EthereumClient, 'get_network', return_value=EthereumNetwork.UNKNOWN)
    ...
    def test_multicall_try_aggregate(self):
        erc20_contract = self.deploy_example_erc20(1, self.ethereum_test_account.address)
        ...
        expected_results = [
            ...
            MulticallDecodedResult(success=False, return_data_decoded=b'\x08\xc3y\xa0\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00#ERC20: transfer to the zero address\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),  # noqa
