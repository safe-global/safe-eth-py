...
from safe_eth.eth.contracts import get_safe_contract, get_safe_V1_0_0_contract
...
class TestSafeCreation2Tx(SafeTestCaseMixin, TestCase):
    def test_safe_create2_tx_builder(self):
        ...
        self.assertEqual(
            ethereum_tx_sent.contract_address, safe_creation_tx.safe_address
        )
    ...
    def test_safe_create2_tx_builder_v_1_0_0(self):
        w3 = self.w3
        tx_hash = (
            get_safe_V1_0_0_contract(self.w3)
            .constructor()
            .transact({"from": self.ethereum_test_account.address})
        )
    ...
    def test_safe_create2_tx_builder_with_token_payment(self):
        ...
        self.assertEqual(
            erc20_contract.functions.balanceOf(safe_creation_tx.safe_address).call(),
    ...
    def test_safe_gas_with_multiple_owners(self):
        logger.info(
            "Test Safe Proxy create2 gas with multiple owners".center(
                LOG_TITLE_WIDTH, "-"
            )
        )
        w3 = self.w3
